...
from testcase_syn.prompt_templates.prompt import PROMPT, TYPE2INSTRUCTION
import requests
...
def build_testcase_prompt(item, turn, sql_dialect="SQLite"):
    ...
    instruction = TYPE2INSTRUCTION.get(sql_type, "- Write a Verification SQL to check the result state.\n- Assert the correctness.")
    ...
    mapping = {
        ...
        "SQL_TYPE_INSTRUCTION": instruction,
        # "FEW_SHOT_EXAMPLES": ""
    }
